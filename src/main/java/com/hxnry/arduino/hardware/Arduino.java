package com.hxnry.arduino.hardware;
...
public class Arduino {
	...
	public boolean openConnection(){
		if(comPort.openPort()){
			...
			AlertBox alert = new AlertBox(new Dimension(400,100),"Error Connecting", "Most likely another application is already connected to the target device.");
			alert.display();
			return false;
		}
	}
